...
$webdriver->get("http://www.polandvisa-ukraine.com/scheduleappointment_2.html");
$element = $webdriver->findElementBy(LocatorStrategy::linkText, "Призначити дату подачі документів");
if ($element) {
    $element->click();
